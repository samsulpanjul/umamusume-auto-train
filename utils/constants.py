...
SKILL_PTS_REGION_2=(760, 725, 825 - 760, 815 - 780)
...
HINT_TEXT_REGION = (330, 655, 765 - 330, 725 - 655)
...
HINT_BBOXES = {
    'spd': (300, 770, 400, 1000),
    'sta': (410, 770, 510, 1000),
    'pwr': (510, 770, 610, 1000),
    'guts': (610, 770, 710, 1000),
    'wit': (720, 770, 820, 1000),
}

MOOD_LIST = ["AWFUL", "BAD", "NORMAL", "GOOD", "GREAT", "UNKNOWN"]

SUPPORT_CARD_ICON_BBOX=(845, 120, 945, 700)
