...
import { minScoreStates, createSupportState } from "@/globals/gameState"
...
export default function FunctionModScoreSelectorCard({ trainingText, cardIndex, initialType, onChange }: Props) {
  const containerRef = useRef<HTMLDivElement>(null)

  const trainingKey = trainingText as keyof typeof minScoreStates
