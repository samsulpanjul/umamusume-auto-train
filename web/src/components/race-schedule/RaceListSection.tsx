    ...
    <div className="section-card relative">
      ...
      {!use_race_schedule && ( 
          <div className="flex flex-1 h-fit items-center justify-center">
            <div className="flex items-center h-fit gap-2 px-4 rounded-full text-sm font-medium animate-in fade-in zoom-in duration-300 border bg-primary/10 border-primary/20 text-secondary -mt-1">
              <AlertCircle size={22} />
