...
export default function ListStatWeight({ config, updateConfig }: Props) {
  const {
    training_strategy: { stat_weight_sets },
  } = config;
  const statWeight = Object.entries(stat_weight_sets);
    ...
    <>
      {statWeight.length === 0 ? (
        <div className="size-full flex flex-col items-center justify-center">
          <p className="text-xl font-semibold">No stat weight sets</p>
