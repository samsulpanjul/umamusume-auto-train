...
export default function FormStatWeight({ config, updateConfig }: Props) {
    ...
    >
      <label htmlFor="set_name" className="flex gap-4 items-center">
        ...
        <Input
          id="set_name"
          type="text"
          placeholder="stat_weight_set_name"
          required
          onChange={(e) => {
      ...
      <label htmlFor="sp" className="flex gap-4 items-center">
        <span className="w-52">SP:</span>
        <Input
          id="sp"
          type="number"
          required
